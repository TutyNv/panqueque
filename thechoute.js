...
case 'neon': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/bneon?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break
/**/case 'matrix': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/matrix?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break		
case 'break': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/breakwall?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break		 
case 'dropwater': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/dropwater?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break	 
case 'lobo': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') if (!q.includes('|')) return reply(`*PORFAVOR ESCRIBE BIEN EL FORMATO:* ${prefix + command} *texto1|texto2*\n\n_Separa el texto 1 del texto 2 con el simbolo "|"_`) reply(`*Porfavor espera un momento, tu logo ${command} esta siendo creado con el texto ${texto1 + texto2}!*`)		 logo = `https://api.zeks.me/api/wolflogo?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text1=${texto1}&text2=${texto2}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break 
case 'flores': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/flowertext?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break	
case 'cross': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/crosslogo?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break 
case 'seda': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`)		 logo = `https://api.zeks.me/api/silktext?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break 
case 'fire': if (!isRegister) return leoply(baby.only.usrReg) if (!q) return reply('*Y el texto para crear el logo donde esta?*') reply(`Su logo de ${command} con el texto ${q}, sera creado a la brevedad`) logo = `https://api.zeks.me/api/glowtext?apikey=FRPuR2WbwVlAI7rKYh16ypU9oxs&text=${q}` sendFileFromUrl(logo, image, {quoted: choute, caption: 'a', sendEphemeral: true}) break		
